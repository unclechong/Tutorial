				...
				<Form hideRequiredMark style={{width:"90%"}} onSubmit={this.handleSubmit.bind(this)}>
					...
					<FormItem {...formItemLayout} label="数据表">
						{getFieldDecorator('data_tabel',{rules:[{required: true, message: '请选择'}]})(
							<Cascader style={{ width: 300 }} options={this.state.options} onChange={this.cascaderOnChange.bind(this)} loadData={this.loadData.bind(this)} changeOnSelect/>
						)}
					</FormItem>
		...
		return (
			<div>
				...
				<Form hideRequiredMark style={{width:"90%"}} onSubmit={this.handleSubmit.bind(this)}>
					...
					<FormItem {...formItemLayout} label="指标计算区间">
